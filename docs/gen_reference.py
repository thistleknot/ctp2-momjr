...
def gen_units():
    ...
    lines.append("<details markdown=\"1\">")
    lines.append("<summary>MoMJR Source Art (with unit name overlay) — click to expand</summary>\n")
    lines.append("![MoMJR Labeled](../img/momjr_units_sheet_labeled.png)\n")
    lines.append("</details>\n")
    lines.append("<details markdown=\"1\">")
    lines.append("<summary>HoMM2 Source Art (with unit name overlay) — click to expand</summary>\n")
    lines.append("![HoMM2 Labeled](../img/homm2_units_sheet_labeled.png)\n")
    lines.append("</details>\n")
    lines.append("<details markdown=\"1\">")
