...
def gen_units():
    ...
    lines.append("</details>\n")
    lines.append("<details markdown=\"1\">")
    lines.append("<summary>LotR Source Art — pending RAR extraction</summary>\n")
    lines.append("Art locked in `H:\\Games\\ctp2\\Lord of the Rings-20260424T030215Z-3-001\\Lord of the Rings\\CTP2_LOTR_100.rar`.\n")
    lines.append("Extract with 7z/unrar and regenerate this sheet.\n")
    lines.append("</details>\n")
    lines.append("<details markdown=\"1\">")
